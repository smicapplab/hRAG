...
- **Iron-Clad Vector Search:**
  ...
  3. **Post-Validation:** As a second layer of defense, search results are cross-verified against the relational permission set _after_ retrieval and before being sent to the client.
